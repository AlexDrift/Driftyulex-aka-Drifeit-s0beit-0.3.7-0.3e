...
const struct weapon_entry	weapon_list[] =
{
	...
	{ 8, 1, 339, "Катана меч" },
	{ 9, 1, 341, "Бензопила" },
	{ 22, 2, 346, "9мм Пистолет" },
	{ 23, 2, 347, "Пистолет с глушителем" },
	{ 24, 2, 348, "Дигл(Пустынный орел)" },
	{ 25, 3, 349, "ШотГун" },
	{ 26, 3, 350, "Обрезы" },
	{ 27, 3, 351, "Военный дробовик" },
	{ 28, 4, 352, "Микро UZI" },
	{ 29, 4, 353, "МП5" },
	{ 32, 4, 372, "Тек9" },
	{ 30, 5, 355, "AK47" },
	{ 31, 5, 356, "M4" },
	{ 33, 6, 357, "Сельская винтовка" },
	{ 34, 6, 358, "Снайперская винтовка" },
	{ 35, 7, 359, "Гранатомет" },
	{ 36, 7, 360, "Самонаводящий RPG" },
	{ 37, 7, 361, "Огнемет" },
	{ 38, 7, 362, "Миниган" },
	{ 16, 8, 342, "Граната" },
	{ 17, 8, 343, "Дымовая шашка" },
	{ 18, 8, 344, "Коктейль молотова" },
	{ 39, 8, 363, "Взрывчатка" },
	{ 41, 9, 365, "Болончик краски" },
	...
	{ 14, 10, 325, "Цветы" },
	{ 15, 10, 326, "Трость" },
	{ 44, 11, 368, "Ночное виденье" },
	{ 45, 11, 369, "Тепловое виденье" },
	{ 46, 11, 371, "Парашут" },
	{ 40, 12, 364, "Детонатор" },
	{ -1, -1, -1, NULL }
};
