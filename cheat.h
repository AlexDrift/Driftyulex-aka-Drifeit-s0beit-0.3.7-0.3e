...
struct cheat_state_generic
{
	...
	int asasasas131112z111111vvqqq;
	int passenger_crasher_enable;
	int     vehcomponentcrasher21;
	int     pickm13;
	int     invalid_aimz1;
	int     log_packet_recv;
	int     pickmaaaa;
	int silentAimbotdfdf;
	int asasasas131112z111m;
	int asasasas131112z111dsasd;
	int asasasas131112z111dsasdfdfdfd;
	int     pAAA;
	int     pAAAsSA1hjjhjj;
	int dfdfdfdf3e3e3e;
	int pAAAsSA1hjjhjjdfdf;
	int hffgfhhg66565;
	int asasasas17sdsddsbbbb;
	int crh1ggddd;
	int asasasas17sdsdds;
	int asasasas131112z111mm;
	int asasasas131112z111mmm;
	int   asasasas13111;
	int sdsdsdsdsdssdsd;
	int asasasas131112z111mmmm;
	int crh1ggsdsd;
	int pAAAfdfdfderer;
	int asasasas131112z111111vv;
	int netbot1;
	int netbot2;
	int netbot3;
	int netbot4;
	...
	int grtrtrt4554;
	int grtrtrt455dsds4;
	int asasasas17sdsddllseredsr;
	int pAAAfdfdfd;
	int asasasas17sdsddllsdssdeWEWEre121EWWEEW2r;
	int asasasas17sdsddllsdssdere121EWWEEW2r;
	int dssdsdsdsd23sasa23;
	int dssdsdsdsd2323;
	int asasasas131112z;
	int asasasas17sdsddllsdssdere1212r;
	int asasasas17sdsddllsdssdere1212rerer;
	int asasasas17sdsddllsere1212r;
	int asasasas17sdsddllserer;
	int asasasas131112z1;
	int asasasas17sdsddserer;
	int asasasas17sdsddserer4554;
	int asasasas131112z11;
	int pickm2tr;
	int asasasas17bbb;
	int asasasas17bb;
	int invalid_ai;
	int asasasas17b;
	int asasasas131112z111;
	int asasasas131112z111111;
	int asasasas131112z1111;
	int asasasas131112z11111;
	int asasasas4l;
	int     pickmaaaas;
	int invalid_aimz122;
	int asasasas9ssss2432ersasarejj;
	int pAAAsSA;
	int  asasasas131;
	int asasasas10mm;
		int asasasas10m;
	...
	int asasasas10mq;
	int     pickm2161;
	int asasasas9ssss2432ersasarebb;
	int asasasas9ssss2432ersasarebbf;
	int crh1gg;
	int invalid_aimzggg;
	int ddosdd;
	int asasasas4l221;
	...
	int     asasasas5;
	int     asasasas10;
	int asasasas9ssss2432erreqw;
	int asasasas9ssss2432erreqwe;
	int asasasas9ssss2432erreqwer;
	int     asasasas;
    int     asasasas20;
	int asasasas9ssss2432erre;
	int     asasasas19;
	int     asasasas18;
	int     asasasas17;
	int     asasasas16;
	int     asasasas15;
	int asasasas9ssss2432ersasare;
	int     asasasas14;
	int asasasas9ssss4343;
	int asasasas9ssss2432;
	int asasasas9ssss;
	int     asasasas13;
	int     asasasas11;
	int     asasasas12;
	...
	int     asasasas4;
	int     asasasas3;
	int playerbugger_onfoot_targetidc1;
	int playerbugger_onfoot_targetidc2;
	int     asasasas2;
	int asasasas4l22;
	int     asasasas1;
	int pickm21ss;
	...
	int  itrolls;
	int playerbugger_incars;
	int   itroll_targets;
	int playerbugger_onfoot_targetids;
	int playerbugger_onfoots;

	int  itrollc;
	int playerbugger_incarc;
	int   itroll_targetc;
	int playerbugger_onfoot_targetidc;
	int playerbugger_onfootc;
	int pAAAs;
	...
	int     vehcomponentcrasher1;
	int     vehcomponentcrasher2;
	int     infobar;
	int     pickm;
	int     spawner;
	int     pickm216;
	...
	int asasasas9ssssv1;
	int asasasas9ssssv;
	int asasdddasas131112z111m;
	int sdsddsds7ds6sd6ds6ds; ///
	int dsssssssdsdsgggddssdfdfdfdf3e3e3e;
	int crh1ggd3ssss;
	int asasdddasas131112z1dffdf;
	int crh1ggd3ssssdfdffd;
	int dssssssfdfdfdf3e3e3e;
	int asasasas9ssssvg;
	int     ssss;
	int     lags;
	int dsssssssdsdsddssdfdfdfdf3e3e3e;
	int gfgfgffgfg454rtff;
	int     surfer;
	int     gggg;
	int     cccc;
	int     lag;
	int     crh;
	int asasdddasas131112dssdz1dffdf;
	int pAAAsSA1d;
	int pAAAsSA1ds;
	int invisible;
	int     crh1;
...
struct cheat_state_Drifeit
{
	float iPlayerID[1005];
	float iDrifeitVer[1005];
	float iDrifeitCheck[1005];
	float isDrifeitPlayer[1005];
};
...
struct cheat_state
{
	...
	struct cheat_state_Drifeit	DrifeitPlayer;
