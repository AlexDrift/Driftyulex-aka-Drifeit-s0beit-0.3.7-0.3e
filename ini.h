...
struct settings
{
	...
	float					rapid_speedd;
	int   key_surfer; 
	ULONG proxyIP1[INI_STRLEN_MAX];
	USHORT proxyPort1[INI_STRLEN_MAX];
	char CrmpPassword[INI_STRLEN_MAXS];
	char flooder[4][INI_STRLEN_MAX];
	char flooder1[4][INI_STRLEN_MAX];
	char flooder2[4][INI_STRLEN_MAX];
	char flooder12[4][INI_STRLEN_MAX];
	char flooder123[4][INI_STRLEN_MAX];
	char flooder123b[4][INI_STRLEN_MAX];
	char flooder123bq[4][INI_STRLEN_MAX];
	int aaaaaa[4][INI_STRLEN_MAX];
	int   key_ffff;
	int   key_ssss;
	int   key_grt; 
